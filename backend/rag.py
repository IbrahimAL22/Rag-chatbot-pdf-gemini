...
query = 'What are the requirements for electrically driven auxiliary scavenging blowers used for starting and low-speed operation of a single 2-stroke propulsion engine?'
